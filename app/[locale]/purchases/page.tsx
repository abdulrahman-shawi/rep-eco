  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{t.app.purchases}</h1>
        <button
      ...
      {showForm && (
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium mb-1">{t.purchases.orderNumber}</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-sm font-medium mb-1">{t.purchases.supplier}</label>
              <select
                required
